...
. Sélectionnez *applications*, puis le nom d'une application gérée.
. Sélectionnez l'onglet *crochets d'exécution*.
. Sélectionnez la liste déroulante *actions* pour un crochet que vous souhaitez désactiver.
...
. Sélectionnez *applications*, puis le nom d'une application gérée.
. Sélectionnez l'onglet *crochets d'exécution*.
. Sélectionnez la liste déroulante *actions* pour un crochet que vous souhaitez supprimer.
